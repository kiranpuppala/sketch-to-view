...
(function($PS) {
  ...
  var num2Str = function (num) {
      ...
      throw new Error("Failed pattern match at Lib.Utils (line 30, column 1 - line 30, column 28): " + [ num.constructor.name ]);
  };
...
(function($PS) {
  ...
  var setLineHeight = function (v) {
      ...
      throw new Error("Failed pattern match at Lib.Parser (line 34, column 1 - line 34, column 40): " + [ v.constructor.name ]);
  };
  var setKerning = function (v) {
      ...
      throw new Error("Failed pattern match at Lib.Parser (line 29, column 1 - line 29, column 37): " + [ v.constructor.name ]);
  };
  ...
  var setHidden = function (v) {
      ...
      throw new Error("Failed pattern match at Lib.Parser (line 21, column 1 - line 21, column 31): " + [ v.constructor.name ]);
  };
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              if (v1.value0.fill === "Color") {
                  return "android:background = " + (Data_Show.show(Data_Show.showString)(Lib_Utils.makeColorStr(v1.value0.color)) + "\x0a");
              };
              if (v1.value0.fill === "Gradient") {
                  var colors = Data_String_Common.joinWith(", ")(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                      return Data_Show.show(Data_Show.showString)(Lib_Utils.makeColorStr(v2.color));
                  })(v1.value0.gradient.stops));
                  var degree = Lib_Utils.num2Str(($$Math.atan2(v1.value0.gradient.to.x - v1.value0.gradient.from.x)(v1.value0.gradient.to.y - v1.value0.gradient.from.y) * 180.0) / $$Math.pi);
                  return "  , gradient $ " + ("Linear" + (" " + (degree + (" [" + (colors + "]\"\x0a")))));
              };
              return " android:background = " + (Data_Show.show(Data_Show.showString)(Lib_Utils.makeColorStr(v1.value0.color)) + "\x0a");
          };
          throw new Error("Failed pattern match at Lib.Parser (line 67, column 3 - line 81, column 1): " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Lib.Parser (line 63, column 1 - line 63, column 46): " + [ v.constructor.name ]);
  };
  var setShapeStyle = function (v) {
      return setOpacity(v.opacity) + setBackground(v.fills);
  };
  ...
  exports["setShapeStyle"] = setShapeStyle;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  ...
  var showShapeLayer = function (v) {
      if (v.shapeType === "Rectangle") {
          return "<LinearLayout \x0a" + (Lib_Parser.setFrame(v.frame) + (Lib_Parser.setHidden(v.hidden) + (Lib_Parser.setShapeStyle(v.style) + " />")));
      };
      return "<LinearLayout \x0a" + (Lib_Parser.setFrame(v.frame) + " />");
  };
...
(function($PS) {
  ...
  var createViewFromLayer = function (v) {
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Sketch_Types.Text) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Lib_Layers.showTextLayer(v.value0.value0));
      };
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Sketch_Types.Image) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Lib_Layers.showImageLayer(v.value0.value0));
      };
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Sketch_Types.Shape) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Lib_Layers.showShapeLayer(v.value0.value0));
      };
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Sketch_Types.Group) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Lib_Layers.showGroupLayer(v.value0.value0));
      };
      return Control_Applicative.pure(Effect.applicativeEffect)("unit");
  };
  var myCommand = function __do() {
      ...
      if (v instanceof Data_Either.Right) {
          ...
          return Control_Bind.bindFlipped(Effect.bindEffect)(Lib_Sketch.copy2Pasteboard)(createViewFromLayer(Data_Array.head(v.value0)))();
      };
      throw new Error("Failed pattern match at Main (line 18, column 28 - line 23, column 76): " + [ v.constructor.name ]);
  };
