...
(function($PS) {
  ...
  var myCommand = function __do() {
      ...
      if (v instanceof Data_Either.Right) {
          ...
          Sketch_UI.alert("Success \u2705")("Copied view to clipboard")();
          return Lib_Sketch.copy2Pasteboard(createViewFromLayer(Data_Array.head(v.value0)))();
      };
      throw new Error("Failed pattern match at Main (line 18, column 28 - line 25, column 72): " + [ v.constructor.name ]);
  };
